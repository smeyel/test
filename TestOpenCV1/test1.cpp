...
{
	// Source file
	//const string filename = "d:\\temp\\MarkerKockaKovetes1.mp4";
	const string filename = "d:\\temp\\gyengeMarkerVideo.MP4";
	//const string filename = "d:\\temp\\gyengeMarkerVideo2.MP4";
